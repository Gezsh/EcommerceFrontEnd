...
const Products = ({cat,filters,sort}) => {
  ...
  useEffect(()=>{
    axios.get(cat ?`https://ecommerceapi-6pwo.onrender.com/api/product?category=${cat} ` : "https://ecommerceapi-6pwo.onrender.com/api/product").then(({data})=>{setProducts(data)
  console.log(data)
